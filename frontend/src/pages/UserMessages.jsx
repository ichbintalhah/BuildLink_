...
const UserMessages = () => {
  ...
  const handleSelectConversation = async (conversation) => {
    ...
    try {
      ...
      setConversations(
        conversations.map((c) =>
          c._id === conversation._id ? { ...c, unreadByCustomer: 0 } : c,
        ),
      );
    } catch (error) {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="opacity-60 mt-1">
            Chat with your contractor about project updates
          </p>
        </div>
        {unreadCount > 0 && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 bg-base-100 rounded-2xl shadow-xl border-2 border-base-300 overflow-hidden min-h-[600px]">
        <div className="lg:col-span-1 bg-base-200/50 p-4 space-y-2 max-h-[600px] overflow-y-auto">
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3">
                  <ChatAvatar
                    imageUrl={conv.contractor?.profilePicture}
                    name={
                      conv.contractor?.fullName ||
            ...
            <>
              <div className="bg-gradient-to-r from-primary to-secondary text-white p-5 border-b border-base-300 shadow-lg">
                <div className="flex items-center gap-3">
                  <ChatAvatar
                    imageUrl={selectedConversation.contractor?.profilePicture}
                    name={
                      selectedConversation.contractor?.fullName ||
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-90 flex items-center gap-1">
                      ...
                      {selectedConversation.projectType || "Project"}
                    </p>
                  </div>
                </div>
              </div>
                ...
                {(selectedConversation.messages || []).map((msg, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={`chat ${isCustomerMessage ? "chat-end" : "chat-start"}`}
                    >
              ...
              <div className="p-5 bg-gradient-to-r from-base-200 to-base-300 border-t-2 border-base-300 shadow-lg">
                ...
                <p className="text-xs opacity-60 mt-2 flex items-center gap-2">
                  <span>💡</span>
                  <span>No phone numbers or contact details allowed</span>
                </p>
              </div>
            </>
          ) : (
